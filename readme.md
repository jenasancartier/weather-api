...
### Description
A web application that allows a user to view the humidity in their area or any provided zip code.  This application practices using APIs.

### Setup/Installation
1. _Clone this repository at:_
  * https://github.com/jenasancartier/weather-api.git
